    ...
    <xsl:template match="/">
        <div rows="0">
            ...
            <xsl:for-each select="PAGINA/CAMPI/CAMPO">
                <div class="anestesiologicoGruppoSanguigno">
                    ...
                    <xsl:if test="@TYPE='input' and @TYPEINPUT='text'">
                        <!--form name="INTERVENTO_CHIRURGICO">
                            <input type="hidden" name="hIdenIntervento" id="hIdenIntervento"/>
                            <input type="hidden" name="htxtInterventoChir" id="htxtInterventoChir"/-->
                            <input>
                                <xsl:attribute name="id">
                                    <xsl:value-of select="@KEY_CAMPO" />
                                </xsl:attribute>
