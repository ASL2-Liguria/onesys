...
{	
	...
	{
		hDescr.value = obj.parentElement.innerText;
		//hCode.value = (obj.codPadre).toString() + '/' + (obj.codice).toString() ;
		hIden.value = iden ;
