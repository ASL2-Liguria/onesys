...
$.extend(Datepicker.prototype, {
	...
	commands: { // Command actions that may be added to a layout by name
		...
		today: {text: 'todayText', status: 'todayStatus', // Today's month
			...
			action: function(inst) { 
				...
				//alert($.datepick.formatDate(dateFormat, $.datepick.today(), inst.getConfig()));
				window.returnValue = $.datepick.formatDate(dateFormat, $.datepick.today(), inst.getConfig()); 
	...
	_update: function(target, hidden) {
		...
		var n = 0;
		$(".datepick-month TABLE").find("tr").each(function(i) {
			n ++;
		});
		if(n == 7){	$('.datepick-popup').addClass("pad10").removeClass("pad20"); }
		else{		$('.datepick-popup').addClass("pad20").removeClass("pad10"); }
	},
	...
	_generateContent: function(target, inst) {
		...
		var picker = this._prepare(renderer.picker, inst).replace(/\{months\}/, monthRows).
			...
			($.browser.msie && parseInt($.browser.version, 10) < 6 && !inst.inline ?
