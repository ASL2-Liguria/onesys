...
var NS_PRESTAZIONI	= {
	...
	carica : function(){
		...
		_filtro_list_elenco.setFromFieldQuery("Radsql.View_Esa_Range_Materiale");
	...
	riportaSelezionati : function(){
		...
		var lstSelezionati			= document.getElementById("EsamiSelezionati");
		var arGiaScelti				= '';
...
var NS_PROFILI = {
	...
	creaOptEsami : function(elenco){
		...
		var Listbox	= document.getElementById('EsamiSelezionati');
		arrayOpt	= new Array();
