...
function caricaUltimeNote(){
	var pBinds = new Array();
	pBinds.push('RICHIESTA_GENERICA_CARDIO_PAR');
	pBinds.push(document.EXTERN.Hiden_anag.value);
    var rs = WindowCartella.executeQuery("OE_Richiesta.xml","getUltimeNote",pBinds);
