...
var _REPARTO_RICHIEDENTE	= $('#REPARTO_RICHIEDENTE').val();
var _CDC_DESTINATARIO		= $('#CDC_DESTINATARIO').val();
var _TIPO					= $('#TIPO').val();
var _URGENZA				= $('#URGENZA').val();
var _METODICA				= $('#METODICA').val();
...
function filtroQuery(){
	...
	_filtro_list_elenco.setFromFieldQuery("table(RADSQL.GETESAMIRICHIEDIBILI('"+_CDC_DESTINATARIO+"','"+_REPARTO_RICHIEDENTE+"','"+_TIPO+"','"+_URGENZA+"','"+_METODICA+"'))");
