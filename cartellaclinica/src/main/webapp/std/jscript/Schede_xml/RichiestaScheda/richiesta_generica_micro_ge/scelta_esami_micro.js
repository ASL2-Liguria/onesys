...
function filtroCorpo(){
	...
	//alert('select cet.iden_tabella, COR.DESCRIZIONE from RADSQL.LABO_SEDI_CORPO COR, RADSQL.COD_EST_TABELLA CET where ORIGINE=\'MICROBIOLOGIA_PIETRA_LIGURE\' AND CET.CODICE=COR.IDEN AND CET.TABELLA = \'MG_ART\' AND CET.IDEN_TABELLA=\''+whereCond+'\' order by DESCRIZIONE ASC');
