...
var _IDEN_SCHEDA			= document.EXTERN.IDEN_SCHEDA.value;
...
function filtroQuery(){
	...
	//alert(_CDC_DESTINATARIO+'\n'+_REPARTO_RICHIEDENTE+'\n'+_TIPO+'\n'+_URGENZA+'\n'+_METODICA+'\n'+_IDEN_SCHEDA);
	_filtro_list_elenco.setFromFieldQuery("table(RADSQL.GETESAMIRICHIEDIBILI_2('"+_CDC_DESTINATARIO+"','"+_REPARTO_RICHIEDENTE+"','"+_TIPO+"','"+_URGENZA+"','"+_METODICA+"','"+_IDEN_SCHEDA+"'))");
	//alert("table(RADSQL.GETESAMIRICHIEDIBILI('"+_CDC_DESTINATARIO+"','"+_REPARTO_RICHIEDENTE+"','"+_TIPO+"','"+_URGENZA+"','"+_METODICA+"','"+_IDEN_SCHEDA+"'))");
