...
var NS_DIARI_OST = {
    ...
    $('form[name="EXTERN"] input[name="WHERE_WK_EXTRA"]').val("(IDEN_VISITA="+vDati.iden_ricovero+" or PARENT="+vDati.iden_ricovero+") and TIPO_DIARIO='OSTETRICO'");     
...
function aux_applica_filtro() {
    ...
    var url = "servletGenerator?KEY_LEGAME=WORKLIST&TIPO_WK=WK_DIARI_OST"+contextMenu+"&ILLUMINA=javascript:illumina(this.sectionRowIndex);";
    applica_filtro(url);
}