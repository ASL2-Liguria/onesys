...
function ab_dis_combo_stampanti()
{
	...
	if(document.form_pc.ip.value != indirizzo_ip && document.form_pc.nome_host.value != nome_host_locale)
	{
		...
		document.form_pc.printername_ricetta_rossa.disabled=true;
	}
	else
	{
		...
		document.form_pc.printername_ricetta_rossa.disabled = false;
...
*/
	alert (ritornaJsMsg('reg'));//"Registrazione effettuata"
...
*/
function combo_box_stampanti_eti_ref(st_eti, st_ref, st_rr)
{
	   ...
	   (document.form_pc.ip.value != document.form_pc.ip_locale.value && document.form_pc.nome_host_locale.value != document.form_pc.		        nome_host.value)))
	{
		...
		document.all.id_st_ricettaRossa.title = "Disabilitato";
	...
	carica_combo_printer(document.form_pc.printername_ricetta_rossa, st_rr);
