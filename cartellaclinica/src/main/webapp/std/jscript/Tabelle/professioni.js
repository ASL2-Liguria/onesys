...
function chiudi_ins_mod()
{
	...
	if(tipo_ricerca == 'DESCR')
		campo_descr = document.form_prof.descr.value;
    else
		campo_descr = document.form_prof.cod_dec.value;
...
function funzione()
{
	document.form_prof.cod_dec.value = '';
	document.form_prof.cod_dec.focus();
}