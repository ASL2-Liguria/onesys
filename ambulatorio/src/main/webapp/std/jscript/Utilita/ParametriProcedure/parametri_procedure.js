...
// parte nuova per nascondere alcune sezioni inutili
// indice iniziale : 0
// 7 appropriatezza
// 8 sicurezza (durata e  lungh pwd)
// 9 refertazione (include info su acr, pacs, sospesi...)
// 10 med.nuc.
// 12 islink
// 13 pacs chsh
// 14 masterizzazione
...
// 18 messaggistica
// 19 ref.strutturato
// 20 integr. con gericos
var indiciSezioniDaNascondere = new Array(7,8,9,10,12,13,14,15,16,17,18,19,20);
$(document).ready(function() 
{	
	$("table[class='classTabHeader']").each(function(indice, valore){
		if ($.inArray(indice,indiciSezioniDaNascondere) > -1){
			$(this).hide();
		}
	});
	// nasconde flag su ACR
	$("input[name='abilita_acr_campi_referto']").parent().parent().hide();
});
// ********************
