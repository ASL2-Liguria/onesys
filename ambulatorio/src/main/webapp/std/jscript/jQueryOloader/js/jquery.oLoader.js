...
(function($) {
    ...
    $.ownage.Loader = function(el, params, selector, number) {
        ...
        base.preloadImages = function() {
            var images = [
                '../../std/jscript/jQueryOloader/images/ownageLoader/loader1.gif',
                '../../std/jscript/jQueryOloader/images/ownageLoader/loader2.gif',
                '../../std/jscript/jQueryOloader/images/ownageLoader/loader3.gif',
                '../../std/jscript/jQueryOloader/images/ownageLoader/loader4.gif',
                '../../std/jscript/jQueryOloader/images/ownageLoader/loader5.gif',
                '../../std/jscript/jQueryOloader/images/ownageLoader/loader6.gif',
                '../../std/jscript/jQueryOloader/images/ownageLoader/loader7.gif'
            ];
    ...
    $.ownage.Loader.defaultOptions = {
        image: '../../std/jscript/jQueryOloader/images/ownageLoader/loader1.gif',
        style: 1,
        context: 'body',
        modal: true,
        fadeInTime: 300,
