...
function registra(tipo_operazione)
{
	...
	//doc.txtDataTaratura.value = doc.txtDataTaratura.value.substring(6,10)+doc.txtDataTaratura.value.substring(3,5)+doc.txtDataTaratura.value.substring(0,2);	
...
function gestioneCausaleMN()
{
	...
	jQuery('#txtDataOrdine').datepick({showOnFocus: false, showTrigger: '<img class="trigger" src="imagexPix/calendario/cal20x20.gif" class="trigger"></img>'});	


	jQuery('#txtDataBolla').datepick({showOnFocus: false, showTrigger: '<img class="trigger" src="imagexPix/calendario/cal20x20.gif" class="trigger"></img>'});	


	jQuery('#txtDataTaratura').datepick({showOnFocus: false, showTrigger: '<img class="trigger" src="imagexPix/calendario/cal20x20.gif" class="trigger"></img>'});	
