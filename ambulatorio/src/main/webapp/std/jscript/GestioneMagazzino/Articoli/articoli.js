...
function registra()
{
	...
	doc.nome_campi.value = 'cod_art*descr*cod_bar*codice_categoria*cod_gara*descr_gara*un_mis*mdc_sino*conto_dep*nuclide*forma_chimica*stato_fisico*data_taratura*tracciante*costo_std_unitario*emivita*attivo';
	doc.request.value = 'cod_art*descr*cod_bar*codice_categoria*cod_gara*descr_gara*un_mis*hmdc_sino*hconto_dep*nuclide*forma_chimica*stato_fisico*txtDaData*htracciante*costo_std_unitario*emivita*hattivo';
 	doc.tipo_campo_db.value = 'S*S*S*S*S*S*S*S*S*S*S*S*S*S*D*D*S';
