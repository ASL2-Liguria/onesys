...
function TB_init(){
	try{
		...
		alert("TB_init - Error: " + e.description);
	}
}
...
function TB_bind(event){
	try{
		...
		alert("TB_bind - Error: " + e.description);
	}
    return false;
}
...
function TB_show(caption, url, rel){
	...
	try{
		if (!$("TB_overlay")) {
			...
			$('TB_load').innerHTML = "<img src='imagexPix/smoothbox/loading.gif' />";
			TB_load_position();
				...
				function buildClickHandler(image){
					return function(){
						try{
							...
							alert("buildClickHandler - Error: " + e.description);
						} 						
						return false;
					};
				}
		...
		alert("TB_show - Error: " + e.description);
	}    
}
...
function TB_showWindow(){
	...
	try{    
		...
		alert("TB_showWindow - Error: " + e.description);
	} 	
}
...
function TB_remove(){
	try{
		...
		alert("TB_remove - Error: " + e.description);
	} 	
    return false;
}
...
function TB_position(){
	try{
		...
		alert("TB_position - Error: " + e.description);
	} 	
}
...
function TB_overlaySize(){
	try{
		...
		alert("TB_overlaySize - Error: " + e.description);
	} 	
...
function TB_load_position(){
	try{
		...
		alert("TB_load_position - Error: " + e.description);
	} 	
}
...
function TB_parseQuery(query){
    ...
    // return empty object
		...
		alert("TB_parseQuery - Error: " + e.description);
	} 	
    return params;
}
