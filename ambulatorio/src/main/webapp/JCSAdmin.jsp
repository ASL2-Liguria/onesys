...
<h1> <a href="JCSAdmin.jsp">Cache Regions</a> </h1>

<style>
.Cache{clear:both;margin:20px;border:1px solid #000;height:42px;}
...
<%
	if(JCScache.isEnabled()){
		%>
		<div class="Cache CacheAttiva">
			<h2>Cache Attiva</h2>
			<a href="JCSAdmin.jsp?action=<%=DISABLE_ACTION%>">Disabilita</a>
		</div>
		<%
	}else{
		%>
		<div class="Cache CacheNonAttiva">
			<h2>Cache NON attiva</h2>
			<a href="JCSAdmin.jsp?action=<%=ENABLE_ACTION%>">Abilita</a>
		</div>
		<%
	}
%>
