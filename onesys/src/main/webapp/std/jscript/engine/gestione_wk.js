...
var _SQL_INS_FILTRI_DB    = "insert into CONF_FILTRI(USER_NAME, TIPO, LASTVALUECHAR) values('#USER_NAME#', #TIPO#, '#LASTVALUECHAR#')";
var _SQL_UPD_FILTRI_DB    = "update CONF_FILTRI set LASTVALUECHAR = '#LASTVALUECHAR#' where USER_NAME = '#USER_NAME#' and TIPO = #TIPO#";
