...
dwr.engine._origScriptSessionId = "0FFDA8547E7EF238B71D9C0A33F81141";
...
dwr.engine._defaultPath = "/fenix-ris/dwr";
...
dwr.engine._stateChange = function(batch) {
    ...
    var req = batch.req;
    try {
        /*jack e principe:  Se 600 (Sessione Scaduta) chiamo la funzione e return;*/
        if (req.readyState != 4) return;

        if(req.status == 600){
            home.NS_FENIX_TOP.handlerExpiredSession(null,req,null,null);
            return;
        };
    }
    catch (ex) {
