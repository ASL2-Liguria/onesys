...
jQuery(document).ready(function () {
    ...
    NS_MOD_CONSTATAZIONE_DECESSO.init();
    NS_MOD_CONSTATAZIONE_DECESSO.setEvents();

});

var NS_MOD_CONSTATAZIONE_DECESSO = {
    firma : false,
    idenScheda: null,

    init: function(){
        NS_FENIX_SCHEDA.customizeParam = function (params) {params.extern = true; return params;};
        NS_FENIX_SCHEDA.successSave = NS_MOD_CONSTATAZIONE_DECESSO.successSave;
        NS_MOD_CONSTATAZIONE_DECESSO.detectStatoPagina();
        NS_MOD_CONSTATAZIONE_DECESSO.checkStatoFirma($("#hStatoScheda").val());
    ...
    setEvents: function(){
        $(".butFirma").on("click", function () {
            NS_MOD_CONSTATAZIONE_DECESSO.firma = true;
    ...
    successSave: function (message) {
        ...
        if (NS_MOD_CONSTATAZIONE_DECESSO.firma == true)
        {
            NS_REGISTRAZIONE_FIRMA.firma();
        }
        /*else
        {
            NS_MODULISTICA_FUNZIONI_COMUNI.refreshModulistica($("#LISTA_CHIUSI").val(), true, function(){home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_CONSTATAZIONE_DECESSO = 'E';});
        }  */
    }
};
...
var NS_REGISTRAZIONE_FIRMA =
{
    firma : function (p) {
        ...
        NS_FIRMA_MODULI.setDocumento("MODULO_CONSTATAZIONE_DECESSO");
        NS_FIRMA_MODULI.setReport("MODULO_CONSTATAZIONE_DECESSO");
        NS_FIRMA_MODULI.setCallback(function(){
            ...
            if (typeof home.CARTELLA !== 'undefined') {
                home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_CONSTATAZIONE_DECESSO = 'E';
            }
