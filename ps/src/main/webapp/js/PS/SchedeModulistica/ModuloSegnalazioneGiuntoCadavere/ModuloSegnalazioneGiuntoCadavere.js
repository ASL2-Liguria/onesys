...
jQuery(document).ready(function () {
    ...
    NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE.init();
    NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE.setEvents();

});

var NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE = {
    firma : false,
    idenScheda : null,

    init: function(){
        NS_FENIX_SCHEDA.customizeParam = function (params) {params.extern = true; return params;};
        NS_FENIX_SCHEDA.successSave = NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE.successSave;
        $('#radSegnalazione').find('div').width(300);
        NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE.detectStatoPagina();
        NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE.checkStatoFirma($("#hStatoScheda").val());
    ...
    setEvents: function(){
        ...
        $(".butFirma").on("click", function () {
            NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE.firma = true;
    ...
    successSave: function (message) {
        ...
        if (NS_MOD_SEGNALAZIONE_GIUNTOCADAVERE.firma == true)
        {
            NS_REGISTRAZIONE_FIRMA.firma();
        }
        /*else
        {
            NS_MODULISTICA_FUNZIONI_COMUNI.refreshModulistica($("#LISTA_CHIUSI").val(), true, function(){home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_SEGNALAZIONE_GIUNTOCADAVERE = 'E';});
        }*/
...
var NS_REGISTRAZIONE_FIRMA =
{
    firma : function (p) {
        ...
        NS_FIRMA_MODULI.setDocumento("MODULO_SEGNALAZIONE_GIUNTOCADAVERE");
        NS_FIRMA_MODULI.setReport("MODULO_SEGNALAZIONE_GIUNTOCADAVERE");
        NS_FIRMA_MODULI.setCallback(function(){
            ...
            if (typeof home.CARTELLA !== 'undefined') {
                home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_SEGNALAZIONE_GIUNTOCADAVERE = 'E';
            }
