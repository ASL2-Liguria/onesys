...
jQuery(document).ready(function () {
    ...
    NS_MOD_TRASPORTO_URG_ELICOTTERO.init();
    NS_MOD_TRASPORTO_URG_ELICOTTERO.setEvents();

});

var NS_MOD_TRASPORTO_URG_ELICOTTERO = {
    firma : false,
    idenScheda : null,
    campoSpecifica: null,
    lblSpecifica: null,
    ...
    init: function(){
        ...
        NS_FENIX_SCHEDA.successSave = NS_MOD_TRASPORTO_URG_ELICOTTERO.successSave;
        NS_FENIX_SCHEDA.beforeSave = NS_MOD_TRASPORTO_URG_ELICOTTERO.beforeSave;
        NS_MOD_TRASPORTO_URG_ELICOTTERO.detectStatoPagina();
        NS_MOD_TRASPORTO_URG_ELICOTTERO.checkStatoFirma($("#hStatoScheda").val());
        NS_MOD_TRASPORTO_URG_ELICOTTERO.buildTable();
        NS_MOD_TRASPORTO_URG_ELICOTTERO.valorizzaCampi();
    ...
    setEvents: function(){
        $(".butFirma").on("click", function () {
            NS_MOD_TRASPORTO_URG_ELICOTTERO.firma = true;
    ...
    successSave: function (message) {
        ...
        if (NS_MOD_TRASPORTO_URG_ELICOTTERO.firma == true)
        {
            NS_REGISTRAZIONE_FIRMA.firma();
        }
        /*else
        {
            NS_MODULISTICA_FUNZIONI_COMUNI.refreshModulistica($("#LISTA_CHIUSI").val(), true, function(){home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_TRASPORTO_URG_ELICOTTERO = 'E';});
        }    */
    }
};
...
var NS_REGISTRAZIONE_FIRMA =
{
    firma : function (p) {
        ...
        NS_FIRMA_MODULI.setDocumento("MODULO_TRASPORTO_URG_ELICOTTERO");
        NS_FIRMA_MODULI.setReport("MODULO_TRASPORTO_URG_ELICOTTERO");
        NS_FIRMA_MODULI.setCallback(function(){
            ...
            if (typeof home.CARTELLA !== 'undefined') {
                home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_TRASPORTO_URG_ELICOTTERO = 'E';
            }
