...
jQuery(document).ready(function () {
    ...
    NS_MOD_INCIDENTE_INTRAOSPEDALIERO.init();
    NS_MOD_INCIDENTE_INTRAOSPEDALIERO.setEvents();

});

var NS_MOD_INCIDENTE_INTRAOSPEDALIERO = {
    firma : false,
    idenScheda : null,

    init: function(){
        NS_FENIX_SCHEDA.customizeParam = function (params) {params.extern = true; return params;};
        NS_FENIX_SCHEDA.successSave = NS_MOD_INCIDENTE_INTRAOSPEDALIERO.successSave;
        NS_MOD_INCIDENTE_INTRAOSPEDALIERO.detectStatoPagina();
        NS_MOD_INCIDENTE_INTRAOSPEDALIERO.checkStatoFirma($("#hStatoScheda").val());
        NS_MOD_INCIDENTE_INTRAOSPEDALIERO.loadDefaults();
    ...
    setEvents: function(){
        $(".butFirma").on("click", function () {
            NS_MOD_INCIDENTE_INTRAOSPEDALIERO.firma = true;
    ...
    successSave: function (message) {
        ...
        if (NS_MOD_INCIDENTE_INTRAOSPEDALIERO.firma == true)
        {
            NS_REGISTRAZIONE_FIRMA.firma();
        }
       /*else
        {
            NS_MODULISTICA_FUNZIONI_COMUNI.refreshModulistica($("#LISTA_CHIUSI").val(), true, function(){ home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_INCIDENTE_INTRAOSPEDALIERO = 'E';});
        }*/
...
var NS_REGISTRAZIONE_FIRMA =
{
    firma : function (p) {
        ...
        NS_FIRMA_MODULI.setDocumento("MODULO_INCIDENTE_INTRAOSPEDALIERO");
        NS_FIRMA_MODULI.setReport("MODULO_INCIDENTE_INTRAOSPEDALIERO");
        NS_FIRMA_MODULI.setCallback(function(){
            ...
            if (typeof home.CARTELLA !== 'undefined') {
                home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_INCIDENTE_INTRAOSPEDALIERO = 'E';
            }
