...
jQuery(document).ready(function () {
    ...
    NS_MOD_PROPOSTA_TSO.init();
    NS_MOD_PROPOSTA_TSO.setEvents();

});

var NS_MOD_PROPOSTA_TSO = {
    ...
    init: function(){
        ...
        NS_FENIX_SCHEDA.successSave = NS_MOD_PROPOSTA_TSO.successSave;
        NS_MOD_PROPOSTA_TSO.detectStatoPagina();
        NS_MOD_PROPOSTA_TSO.checkStatoFirma($("#hStatoScheda").val());
    ...
    setEvents: function(){
        $(".butFirma").on("click", function () {
            NS_MOD_PROPOSTA_TSO.firma = true;
    ...
    successSave: function (message) {
        ...
        if (NS_MOD_PROPOSTA_TSO.firma == true)
        {
            NS_REGISTRAZIONE_FIRMA.firma();
        }
        /*else
        {
            NS_MODULISTICA_FUNZIONI_COMUNI.refreshModulistica($("#LISTA_CHIUSI").val(), true, function(){home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_PROPOSTA_TSO = 'E';});
        } 9*/
    }
};
...
var NS_REGISTRAZIONE_FIRMA =
{
    firma : function (p) {
        ...
        NS_FIRMA_MODULI.setDocumento("MODULO_PROPOSTA_TSO");
        NS_FIRMA_MODULI.setReport("MODULO_PROPOSTA_TSO");
        NS_FIRMA_MODULI.setCallback(function(){
            ...
            if (typeof home.CARTELLA !== 'undefined') {
                home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_PROPOSTA_TSO = 'E';
            }
