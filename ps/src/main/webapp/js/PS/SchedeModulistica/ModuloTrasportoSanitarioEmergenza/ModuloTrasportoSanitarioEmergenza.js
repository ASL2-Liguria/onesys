...
jQuery(document).ready(function () {
    ...
    NS_MOD_TRASPORTO_SANITARIO_EMERGENZA.init();
    NS_MOD_TRASPORTO_SANITARIO_EMERGENZA.setEvents();

});

var NS_MOD_TRASPORTO_SANITARIO_EMERGENZA = {
    firma : false,
    idenScheda : null,
    campoSpecifica: null,
    lblSpecifica: null,
    ...
    init: function(){
        ...
        NS_FENIX_SCHEDA.successSave = NS_MOD_TRASPORTO_SANITARIO_EMERGENZA.successSave;
        NS_MOD_TRASPORTO_SANITARIO_EMERGENZA.detectStatoPagina();
        NS_MOD_TRASPORTO_SANITARIO_EMERGENZA.checkStatoFirma($("#hStatoScheda").val());
    ...
    setEvents: function(){
        ...
        $(".butFirma").on("click", function () {
            NS_MOD_TRASPORTO_SANITARIO_EMERGENZA.firma = true;
    ...
    successSave: function (message) {
        ...
        if (NS_MOD_TRASPORTO_SANITARIO_EMERGENZA.firma == true)
        {
            NS_REGISTRAZIONE_FIRMA.firma();
        }
        /*else
        {
            NS_MODULISTICA_FUNZIONI_COMUNI.refreshModulistica($("#LISTA_CHIUSI").val(), true, function(){home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_TRASPORTO_SANITARIO_EMERGENZA = 'E';});
        }*/
...
var NS_REGISTRAZIONE_FIRMA =
{
    firma : function (p) {
        ...
        NS_FIRMA_MODULI.setDocumento("MODULO_TRASPORTO_SANITARIO_EMERGENZA");
        NS_FIRMA_MODULI.setReport("MODULO_TRASPORTO_SANITARIO_EMERGENZA");
        NS_FIRMA_MODULI.setCallback(function(){
            ...
            if (typeof home.CARTELLA !== 'undefined') {
                home.CARTELLA.jsonData.H_STATO_PAGINA.MODULO_TRASPORTO_SANITARIO_EMERGENZA = 'E';
            }
