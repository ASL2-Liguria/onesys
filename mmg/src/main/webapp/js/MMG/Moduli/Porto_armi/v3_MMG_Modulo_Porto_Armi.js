...
var MODULO_PORTO_ARMI = {
			...
			setLayout:function(){
				...
				$("#radMalattieSysNervoso, #radTurbePsichiche, #radSostanzeStupefacenti").parent().attr("colSpan","2");
			},
			...
			stampa: function(pIden){
				...
				home.NS_PRINT.print({
					...
					path_report: "MODULO_PORTO_ARMI_V3.RPT" + "&t=" + new Date().getTime(),
					prompts: prompts,
