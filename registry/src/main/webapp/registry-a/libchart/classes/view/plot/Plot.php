...
//            $this->graphCaptionRatio = 0.50; // Roberto
			$this->graphCaptionRatio = 0.80; // Roberto
		...
		public function createImage() {
			...
			$this->backGroundColor = new Color(255, 255, 255); // Roberto
//			$this->backGroundColor = new Color(0, 153, 0); // Roberto
