<?php
	...
	class Primitive {
		...
		public function line($x1, $y1, $x2, $y2, $color, $width = 1) {
			$delta =  $width / 2; // Roberto
//			imagefilledpolygon($this->img, array($x1, $y1 - $width / 2, $x1, $y1 + $width / 2, $x2, $y2 + $width / 2, $x2, $y2 - $width / 2), 4, $color->getColor($this->img)); // Roberto
			imagefilledpolygon($this->img, array($x1, $y1 - $delta, $x1, $y1 + $delta, $x2, $y2 + $delta, $x2, $y2 - $delta), 4, $color->getColor($this->img)); // Roberto
