...
( function() {
	...
	CKEDITOR.plugins.add( 'widget', {
		...
		setAfterDragAndDrop: function( valore ) {
			afterDragAndDrop=valore;
		},
		getAfterDragAndDrop: function() {
			return afterDragAndDrop;
		}
	...
	function onBlockWidgetDrop( sorted ) {
		...
		liner.hideVisible();
		try{
			NS_REFERTO.vocale.generateImgCaption();
		}
		catch (e)
		{}
	}
